...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.lstm_seasonal = nn.LSTM(1, self.hidden_dim, self.num_layers, batch_first=True, dropout=0.2)
        self.linear_seasonal = nn.Linear(self.hidden_dim, self.pred_len)
        self.lstm_trend = nn.LSTM(1, self.hidden_dim, self.num_layers, batch_first=True, dropout=0.2)
